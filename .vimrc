...
" git wrapper, show git branch name when using vim-airline
...
"" Paint css colors with the real color -->terry:: slow vim open speed
...
"cursor settings in gnome-terminal
